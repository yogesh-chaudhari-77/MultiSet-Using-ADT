 ...
 * [1] Binary Search Tree - GeeksforGeeks
   ...
   Lecture notes
 */
public class BstMultiset_NOT_IN_USE extends RmitMultiset
{
	...
	public RmitMultiset union(RmitMultiset other) {
		...
		BstMultiset_NOT_IN_USE retSet = new BstMultiset_NOT_IN_USE();
		...
		TreeNode secTreePtr = getSmallestElementFromTree(((BstMultiset_NOT_IN_USE) other).getRoot());
